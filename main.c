 ...
 *
 * This is a software in C language for calculating numerical integration by
 * adopting different techniques
 *
...
/*! \brief the main function
        ...
        here we define the polynomial, set the integration range and set the
   number of equally spaced intervals in which the range should be divided the
   points delimiting the intervals are defined and then the integration is
   finalized
...
int main() {
  ...
  /* this array will store the (steps+1) values of the polynomial that are
   * delimiting the equally spaced intervals*/
  ...
  /* to get the value of the polynomial at the different points that are
  ...
  printf("\nRectangular rule - The integral between %f and %f is in the "
         "interval: [%f,%f]\n",
